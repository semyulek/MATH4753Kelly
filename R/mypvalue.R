#' @title P value area graph
#'
#' @param t0 The calculation of our t statistic.
#' @param xmax The x range of values that we want to be graphed.
#' @param n The size of our sample.
#' @param alpha The confidence level 1-alpha.
#'
#' @return Returns the p-value and t statistic, as well as a graph of the region where we reject the null hypothesis indicated by two vertical lines.
#' @export
#'
#' @examples
